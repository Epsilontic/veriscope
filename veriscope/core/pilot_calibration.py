...
def calibrate_pilot(control_dir: Path, injected_dir: Path) -> Dict[str, Any]:
    ...
    if control_gates in ("missing", "invalid"):
    ...
    delay_w = None
    if injected_gates == "missing":
        missing_fields.append("injected.results.json_missing")
    elif injected_gates == "invalid":
        missing_fields.append("injected.results.json_invalid")
    else:
