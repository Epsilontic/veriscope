...
class TestGateEngineSemantics:  
    ...
    def test_persistence_k2_warn_then_fail(self, fr_window, make_gate_engine):  
        ...
        r1 = ge.check(  
            past, {"test_metric": np.full(200, 0.9, dtype=float)}, counts,  
            gain_bits=0.1, kappa_sens=0.0, eps_stat_value=0.0,  
        )  
        ...
        r2 = ge.check(  
            past, {"test_metric": np.full(200, 0.95, dtype=float)}, counts,  
            gain_bits=0.1, kappa_sens=0.0, eps_stat_value=0.0,  
        )  
    ...
    def test_audit_schema_insufficient_evidence_hard_contract(self, fr_window, make_gate_engine):  
        ...
        required = [  
            "evaluated", "reason",  
            "evidence_total", "total_evidence", "min_evidence",  
            "policy",  
            "consecutive_exceedances", "consecutive_exceedances_before", "consecutive_exceedances_after",  
            "persistence_k", "persistence_fail",  
            "gain_bits", "gain_thr", "gain_evaluated", "ok_gain", "gain_below_threshold",  
            "eps", "eps_sens",  
            "kappa_sens", "kappa_checked",  
            "counts_by_metric",  
            "worst_DW", "eps_stat", "eps_eff",  
            "per_metric_tv", "per_metric_n", "drifts",  
            "dw_exceeds_threshold", "ok_stab",  
            "min_metrics_exceeding", "min_metrics_exceeding_effective",  
            "n_metrics_exceeding", "metrics_exceeding",  
            "multi_metric_filtered", "dw_exceeds_threshold_raw", "ok_stab_raw",  
            "trend_x", "trend_x_source", "trend_n", "check_idx",  
            "margin_change_raw", "margin_change_eff", "margin_change_slope_eff",  
            "margin_change", "margin_change_slope",  
            "margin_change_rel_raw", "margin_change_rel_eff",  
            "regime_state",  
        ]  
        for k in required:  
    ...
    def test_audit_schema_no_finite_metrics_hard_contract(self, fr_window, make_gate_engine):  
        ...
        required = [  
            "evaluated", "reason", "policy",  
            "consecutive_exceedances", "consecutive_exceedances_before", "consecutive_exceedances_after",  
            "persistence_k", "persistence_fail",  
            "gain_bits", "gain_thr", "gain_evaluated", "ok_gain", "gain_below_threshold",  
            "worst_DW",  
            "eps", "eps_sens", "eps_stat", "eps_eff",  
            "kappa_sens", "kappa_checked",  
            "counts_by_metric",  
            "evidence_total", "total_evidence", "min_evidence",  
            "eps_aggregation",  
            "per_metric_tv", "per_metric_n", "drifts",  
            "dw_exceeds_threshold", "dw_exceeds_threshold_raw",  
            "ok_stab", "ok_stab_raw",  
            "min_metrics_exceeding", "min_metrics_exceeding_effective",  
            "n_metrics_exceeding", "metrics_exceeding", "multi_metric_filtered",  
            "trend_x", "trend_x_source", "trend_n", "check_idx",  
            "margin_change_raw", "margin_change_eff", "margin_change_slope_eff",  
            "margin_change", "margin_change_slope",  
            "margin_change_rel_raw", "margin_change_rel_eff",  
    ...
    def test_audit_schema_evaluated_core_subset(self, fr_window, make_gate_engine):  
        ...
        core = [  
            "evaluated", "policy",  
            "worst_DW", "eps_eff",  
            "counts_by_metric", "evidence_total", "min_evidence",  
            "dw_exceeds_threshold", "persistence_fail",  
            "trend_x", "trend_x_source", "trend_n", "check_idx",  
            "margin_change_eff", "margin_change_slope_eff",  
            "regime_state",  
        ]  
        for k in core:  
